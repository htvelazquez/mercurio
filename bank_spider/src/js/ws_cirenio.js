var wsCirenio = {
  ...
  getToken: function (email, callback) {
    ...
    // xhr.open('POST', LEADGEN_URL + '/auth');
  ...
  getTask: function (callback) {
    ...
    //
    //     if (xhr.status === 401) {
    //       obj_ws.getToken(spiderExtension.user.email, callback);
    //     }
    //   };
    //   xhr.send();
    // } else {
  ...
  sendCompany: function (jobs_companies_id, companyData, callback) {
    ...
    //
    // var xhr = new XMLHttpRequest();
    // xhr.open('POST', LEADGEN_URL + '/job/' + jobs_companies_id + '/company');
    // xhr.setRequestHeader('Content-Type', 'application/json');
    // xhr.setRequestHeader('Authorization', 'Bearer ' + obj_ws.token);
    //
    // xhr.onload = function () {
  ...
  sendEmployees: function (jobs_companies_id, employees, callback) {
    ...
    //
    // var xhr = new XMLHttpRequest();
    // xhr.open('POST', LEADGEN_URL + '/job/' + jobs_companies_id + '/contacts');
    // xhr.setRequestHeader('Content-Type', 'application/json');
    // xhr.setRequestHeader('Authorization', 'Bearer ' + obj_ws.token);
    //
    // xhr.onload = function () {
  ...
  closeJob: function (jobs_companies_id, callback) {
    ...
    //
    // var xhr = new XMLHttpRequest();
    // xhr.open('PUT', LEADGEN_URL + '/job/' + jobs_companies_id);
    // xhr.setRequestHeader('Content-Type', 'application/json');
    // xhr.setRequestHeader('Authorization', 'Bearer ' + obj_ws.token);
    //
    // xhr.onload = function () {
  ...
  checkLimit: function (callback) {
    ...
    //
    // var xhr = new XMLHttpRequest();
    // xhr.open('GET', LEADGEN_URL + '/limit');
    // xhr.setRequestHeader('Content-Type', 'application/json');
    // xhr.setRequestHeader('Authorization', 'Bearer ' + obj_ws.token);
    //
    // xhr.onload = function () {
    ...
    //     var data = JSON.parse(xhr.responseText);
    //
    //     if (data.refresh_token == true) {
    //       obj_ws.getToken(spiderExtension.user.email);
    //     }
    //
    //     callback(data);
    //   }
