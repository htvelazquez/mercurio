...
git_branch = "master"
releases_dir = "/var/www/grabberjobsmanager/releases"
git_repo = "/insidevault2015/grabberjobsmanager.git"
git_user = ""
repo_dir = "/var/www/grabberjobsmanager/repo"
persist_dir = "/var/www/grabberjobsmanager/persist"
next_release = "%(time).0f" % {'time': time()}
current_release = "/var/www/grabberjobsmanager/current"
last_release_file = "/var/www/grabberjobsmanager/LAST_RELEASE"
current_release_file = "/var/www/grabberjobsmanager/CURRENT_RELEASE"
