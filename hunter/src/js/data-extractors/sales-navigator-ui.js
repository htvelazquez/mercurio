...
var SalesNavigatorEmployeesExtractor = {
  ...
  getEmployees: function () {
    ...
    for (var i in this.datajson.elements) {
      var profileId = (this.datajson.elements[i].entityUrn) ? this.datajson.elements[i].entityUrn.replace('urn:li:fs_salesProfile:(', '').replace(')', '') : null;

      var profileURL = (profileId) ? 'https://www.linkedin.com/sales/people/' + profileId : null;

      console.log(this.datajson.elements[i]);
      console.log(this.datajson.elements[i].entityUrn);
      console.log(profileId);
      console.log(profileURL);

      if (profileURL) {
        result.push(profileURL);
      }
    }
