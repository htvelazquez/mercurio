        ...
        <div class="container-fluid">
          <div class="slider-text d-md-flex align-items-center" data-scrollax-parent="true">
              <div class="one-forth pr-md-4 ftco-animate align-self-md-center" data-scrollax=" properties: { translateY: '70%' }">
                  <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Verificá solvencia instantaneamente</h1>
                  <p class="mb-md-5 mb-sm-3" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Servicio unificado para acceder a datos de identidad, saldos y transacciones desde la cuenta bancaria de sus usuarios.</p>
                ...
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            ...
                            <p>Accedé a los datos de identidad y el saldo de las todas transacciones de tu cliente en menos de 10 minutos y completamente on-line.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                ...
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            ...
                            <p>Alcanzá a una mayor cantidad de clientes sin necesidad de un despliegue geográfico.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            ...
                            <p>Mejorá las métricas de su negocio, disminuyendo el tiempo de conversión y eliminando la burocracia.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 d-flex align-self-stretch ftco-animate">
                    <div class="media block-6 services d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            ...
                            <p>Conseguí un informe 360 de los ingresos y egresos de tu cliente, información real y actualizada.</p>
                        </div>
                    </div>
                </div>
            </div>
