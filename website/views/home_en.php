        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="#meetus" class="nav-link">Meet us</a></li>
                    <li class="nav-item cta"><a href="#contact-us" class="nav-link"><span>Request a demo</span></a></li>
                    <li class="nav-item">
        ...
        <div class="container-fluid">
            <div class="slider-text d-md-flex align-items-center" data-scrollax-parent="true">
                <div class="one-forth pr-md-4 ftco-animate align-self-md-center" data-scrollax=" properties: { translateY: '70%' }">
                    <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Discovery <br> Research <br> Updating</h1>
                    ...
                    <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href="#contact-us" class="btn btn-primary px-4 py-3">Request a demo</a></p>
                </div>
                    ...
                    <div class="slider-carousel owl-carousel owl-loaded owl-drag">
                        <div class="owl-stage-outer">
                            <div class="owl-stage" style="transform: translate3d(-3960px, 0px, 0px); transition: all 0s ease 0s; width: 6930px;">
                                <div class="owl-item active" style="width: 990px;">
                                    <div class="item">
                                        <img src="images/dashboard_full_1.png" class="img-fluid img" alt="">
                                    </div>
                                </div>
                                <div class="owl-item" style="width: 990px;">
                                    <div class="item">
            ...
            <div class="row">
                <div class="col-md-12 nav-link-wrap mb-5 pb-md-5 pb-sm-1 ftco-animate">
                    <div class="nav ftco-animate nav-pills justify-content-center text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link active" id="v-pills-nextgen-tab" data-toggle="pill" href="#v-pills-nextgen" role="tab" aria-controls="v-pills-nextgen" aria-selected="true">Discovery</a>
                        <a class="nav-link" id="v-pills-performance-tab" data-toggle="pill" href="#v-pills-performance" role="tab" aria-controls="v-pills-performance" aria-selected="false">Research</a>
                        <a class="nav-link" id="v-pills-effect-tab" data-toggle="pill" href="#v-pills-effect" role="tab" aria-controls="v-pills-effect" aria-selected="false">Updating</a>
                    </div>
                </div>
