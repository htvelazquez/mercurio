<head>
  ...
  <title>Banking Solution :: Cirenio</title>

  <link rel="shortcut icon" href="/views/img/favicon/favicon.ico" type="image/x-icon">
  <link rel="icon" href="/views/img/favicon/favicon.ico" type="image/x-icon">
